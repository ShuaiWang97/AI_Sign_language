...
class LoadIrish_SL_imbal_Data:
    ...
    def __init__(self, val_size: int = 100):
        ...
        self.pool_size = 35686 - self.train_size - self.val_size
...
class LoadChinese_SL_imbal_Data:
    ...
    def download_dataset(self):
        ...
        train_csv=["./sign_dataset/sampled_sign_Chinese_SL_train.csv",
                 ]
        mnist_train = MyDataset(train_csv)

        test_csv = ["./sign_dataset/sign_Chinese_SL_test.csv"
                  ]
        mnist_test = MyDataset(test_csv)
        self.size=28
        return mnist_train, mnist_test
...
class LoadGSL_imbal_Data:
    ...
    def download_dataset(self):
        ...
        train_csv=[#"./sign_dataset/full_size_dataset/sampled_sign_GSL_train_50.csv",
                   "./sign_dataset/sampled_sign_GSL_train.csv",
                 ]
        mnist_train = MyDataset(train_csv)

        test_csv = [#"./sign_dataset/full_size_dataset/sign_GSL_test_50.csv",
                    "./sign_dataset/sign_GSL_test.csv"
                  ]
        mnist_test = MyDataset(test_csv)
        self.size=28
        return mnist_train, mnist_test
